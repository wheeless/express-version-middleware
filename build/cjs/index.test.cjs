...
describe('Version Middleware', () => {
    ...
    describe('Version normalization and matching', () => {
        test.each([
            ...
            (0, index_js_1.versionMiddleware)(handlers)(mockRequest, mockResponse, mockNext);
    ...
    describe('Error handling', () => {
        ...
        test('handles empty version map', () => {
            ...
            (0, index_js_1.versionMiddleware)({})(mockRequest, mockResponse, mockNext);
    ...
    describe('Semantic version handling', () => {
        test.each([
            ...
            mockRequest.params = { version: requested };
            (0, index_js_1.versionMiddleware)(semverHandlers)(mockRequest, mockResponse, mockNext);
            expect(v3Handler).toHaveBeenCalled();
        });
    });
});
