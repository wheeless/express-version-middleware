import { versionMiddleware } from './index.js';
describe('Version Middleware', () => {
    ...
    describe('Version normalization and matching', () => {
        test.each([
            ...
            versionMiddleware(handlers)(mockRequest, mockResponse, mockNext);
    ...
    describe('Error handling', () => {
        ...
        test('handles empty version map', () => {
            ...
            versionMiddleware({})(mockRequest, mockResponse, mockNext);
    ...
    describe('Semantic version handling', () => {
        test.each([
            ...
            mockRequest.params = { version: requested };
            versionMiddleware(semverHandlers)(mockRequest, mockResponse, mockNext);
            expect(v3Handler).toHaveBeenCalled();
        });
    });
});
